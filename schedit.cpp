...
void SCH_EDIT_FRAME::OnEditItem( wxCommandEvent& aEvent )
{
	...
	std::cout<<"just outside the switch case"<<"\n";
    switch( item->Type() )
    {
    
    case SCH_COMPONENT_T:
    {
    	std::cout<<"inside the outer switch case"<<"\n";
        switch( aEvent.GetId() )
        {
        ...
        case ID_SCH_EDIT_ITEM:
        	std::cout<<"inside the inner switch case"<<"\n";
            EditComponent( (SCH_COMPONENT*) item );
            break;
 // ADDED   //////////////////////////////////////////////////////////////////////////       
        
       
        case ID_SCH_EDIT_PROPERTIES:
             EditProperties( (SCH_COMPONENT*) item );
             break;
///////////// 
        default:
