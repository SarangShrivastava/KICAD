...
void AddMenusForEditComponent( wxMenu* PopMenu, SCH_COMPONENT* Component )
{
   ...
   // added 
    msg = AddHotkeyName( _( "Properties" ), s_Schematic_Hokeys_Descr, HK_PROPERTIES );
    AddMenuItem( editmenu, ID_SCH_EDIT_PROPERTIES, msg, KiBitmap( edit_component_xpm ) ); 
    std::cout<<"creating the menu"<<"\n";
  //
